...
*Setup instructions for a Gitian build of Bitcoin Flash using a Debian VM or physical system.*
...
- [Building Bitcoin Flash](#building-dash-core)
...
Clone the git repositories for Bitcoin Flash and Gitian.
...
in the Bitcoin Flash repository under 'Fetch and build inputs' to install sources which require
...
To build Bitcoin Flash (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Bitcoin Flash repository.
