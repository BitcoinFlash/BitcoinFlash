...
If you are building `bitcoinflashd` or `Bitcoin Flash` for others, your build machine should be set up
...
Once dependencies are compiled, see [doc/release-process.md](release-process.md) for how the Bitcoin Flash
...
-------
    ...
    ./bitcoinflashd -daemon # to start the dash daemon.
