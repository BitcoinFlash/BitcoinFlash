...
Bitcoin Flash is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Bitcoin Flash, where everyone uses
...
pay attention to for reviewers of Bitcoin Flash code.

General Bitcoin Flash
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Bitcoin Flash uses tinyformat, which is type safe. Leave them out to avoid confusion
