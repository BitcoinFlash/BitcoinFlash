...
const char * const BITCOIN_CONF_FILENAME = "bitcoinflash.conf";
const char * const BITCOIN_PID_FILENAME = "bitcoinflashd.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BitcoinFlash";
#else
    // Unix
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty bitcoinflash.conf if it does not excist
